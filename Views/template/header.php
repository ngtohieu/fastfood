            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./"><i style="font-size: 34px;color: green;">FastFood</i></a>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="resource/img/banner/banner-3.jpg" style="background-image: url(&quot;resource/img/banner/banner-3.jpg&quot;);height:300px;">
                        <div class="hero__text">
                            <span>Thức ăn ngon</span>
                            <h2>Ngon lành <br>100% sạch</h2>
                            <p style="color: revert;">Nhận và giao hàng miễn phí</p>
